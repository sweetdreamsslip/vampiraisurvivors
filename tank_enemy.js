...
function spawnTankEnemy() {
    ...
    var health = 60 * (difficulty_modes[difficulty]?.enemy_health_multiplier || 1);
    var damage = 20 * (difficulty_modes[difficulty]?.enemy_damage_multiplier || 1);
    
    var tankEnemy = new TankEnemyObject(enemySprite, x, y, health, damage);
    enemies_list.push(tankEnemy);
}

console.log('TankEnemy carregado!');
